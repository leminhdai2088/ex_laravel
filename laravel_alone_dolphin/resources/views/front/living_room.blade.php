...
<body class="w-[1200px] m-auto">
    ...
    <div class="main">
        <div class="nav-room">
            <p class="direction">
                <a href="/home"><i>Trang chủ</i></a> / <a href="#"><i>PHÒNG KHÁCH - Living Room</i></a> / <span class="opacity-08">PHÒNG KHÁCH - Living Room</span>
            </p>
            <table>
                <tr>
                    <td><a href="/list_product">SOFA</a></td>
                    <td><a href="/list_product">GHẾ ĐÔN, GHẾ BĂNG</a></td>
                    <td><a href="/list_product">KỆ, TỦ TV</a></td>
                    <td><a href="/list_product">KỆ, TỦ GIÀY</a></td>
             
                </tr>
                <tr>
                    <td><a href="/list_product">ĐỒNG HỒ</a></td>
                    <td><a href="/list_product">TRANH ẢNH</a></td>
                    <td><a href="/list_product">GỐI TRANG TRÍ</a></td>
        ...
        <div class="slider">
            <h1 class="text-center">PHÒNG KHÁCH - Living Room</h1>
            <img src="/front/images/Living_Room_img/slider.webp" alt="">
        </div>
