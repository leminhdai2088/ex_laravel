    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-7">
                    ...
                    <div class="row mb-3">
                        <div class="col-8">
                            <input name="name" type="text" class="product-name form-control" placeholder="Họ và tên" value="{{ Auth::user()->name }}" required>
                        </div>
                    </div>

                    <input name="email" class="form-control mb-3" aria-label="With textarea" placeholder="Email" value="{{ Auth::user()->email }}"
