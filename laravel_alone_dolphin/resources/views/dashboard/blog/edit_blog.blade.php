...
<form action="/admin/edit_blog/{{ $blog->id }}" method="POST">
    @method('PATCH')
    <input type="hidden" name="_token" value="{{csrf_token()}}">

    <div class="container">
        <h2 class="text-center font-weight-bold mt-4 mb-4">Sửa thông tin blog</h2>
        ...
        <div class="row">
            ...
            <div class="col-7">
                ...
                <div class="row mb-3">
                    <div class="col-8">
                        <textarea name="title" type="text" class="product-name form-control"
                ...
                <div class="row mb-3">
                    <div class="col-8">
                        <textarea name="short_description" class="product-name form-control"
                ...
                <div class="row mb-3">
                    <div class="col-8">
                        <textarea name="keywords" type="text" class="product-name form-control"
                        required>{{ $blog->keywords }}</textarea>
                    </div>
                </div>

                <div class="row mb-3">
                    <div class="col-8">
                        <textarea name="content" type="text" class="product-name form-control"
                ...
                <div class="row mb-3">
                    <div class="col-8">
                        <input name="author" value="{{ $blog->author }}" type="text" class="product-name form-control"
                        required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-8">
                        <input name="status" value="{{ $blog->status }}" type="text" class="product-name form-control"
                        required>
                    </div>
                </div>
