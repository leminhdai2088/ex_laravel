    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-7">
                    ...
                    <div class="row mb-3">
                        <div class="col-8">
                            <input name="name" type="text" class="product-name form-control" placeholder="Tên sản phẩm" value="{{ $product->name }}" required>
                        </div>
                    </div>

                    <input name="size" class="form-control mb-3" aria-label="With textarea" placeholder="Kích thước" value="{{ $product->product_details->size }}"
                        style="height: 50px; resize: none;" required>

                    <input name="material" class="form-control mb-3" aria-label="With textarea" placeholder="Chất liệu" value="{{ $product->material }}"
                        style="height: 50px; resize: none;" required>
